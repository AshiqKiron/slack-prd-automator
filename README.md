...
### Screenshot one - Task created in the Jira Board ![Screenshot 1](2.png)
### Screenshot two - Detailed PRD inside the task ![Screenshot 2](1.png)
### Screenshot Three - Slack confirmation notification after creating the PRD ![Screenshot 3](3.png)
